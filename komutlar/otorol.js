...
exports.run = async (bot, message, args) =>
{
  ...
  profil[message.guild.id].kanal = mentionedChannel.id
	...
	const embed = new Discord.RichEmbed()
		.setDescription(`<495950668725747733>  Otorol başarıyla ${args[0]} olarak ayarlandı! \n<495950668725747733>  Otorol Mesaj kanalı başarıyla ${mentionedChannel} olarak ayarlandı`)
		.setColor("RANDOM")
		.setTimestamp()
