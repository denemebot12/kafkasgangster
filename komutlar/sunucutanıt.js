...
exports.run = async (client, message, args) => {
  ...
  .setTitle('BAŞARILI')
.setDescription('Sunucunuz Başarıyla [Destek Sunucusunda Yani Burada Tanıtıldı](https://discord.gg/8u9Pb5p).\n12 saat Sonra sunucunuzu Tekrardan Tanıtabilirsiniz.')
        .setColor('GREEN')
 message.channel.sendEmbed(embed);
    message.channel.createInvite({maxAge: 0}).then((invite) => {
      ...
      .setThumbnail(message.guild.iconURL)
       client.channels.get('582217496795283476').send(embed)
            });
